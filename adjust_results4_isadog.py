...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        line = infile.readline().strip()  # Read the first line and strip newline

        # Process each line in the file until reaching EOF
        while line != "":
            # Remove newline character and add the dogname to dognames_dic
            dognames_dic[line] = 1
    ...
    # Iterate through results_dic, if labels are found in dognames_dic, then
    # label "is a dog" index 3/4=1; otherwise, index 3/4=0 "not a dog".
